    ...
    settings = {
        java = {
            ...
            configuration = {
                ...
                -- DONE: Update this by adding any runtimes that you need to support your Java projects and removing any that you don't have installed
...
config["on_attach"] = function(client, bufnr)
    ...
    buf_set_keymap("n", "<leader>trc", "<CMD>lua require('jdtls').test_class()<CR>", { desc = "Test Class" })
    buf_set_keymap(
        "n",
        "<leader>tra",
